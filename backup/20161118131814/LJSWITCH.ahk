...
ShowConfigs(){
	...
	Gui, Add, Radio, x20  y110 w110 h20 gChangLang vAltShift, Alt + Shift
	Gui, Add, Radio, x130 y110 w110 h20 gChangLang vWinSpace, Win + Space
...
{
		MsgBox ค่าเริมต้น `n เริ่มด้วย `n`nAfter you click on the Ok button`nbelow, you will be able to choose`nhow you wish to setup your Halo`ngame play.`n 
	}
	Else
	{
