...
ShowConfigs(){
	...
	Gui, Font
	if (iOpt = 1){
		Gui, Add, Radio, Group x20 y60 w245 h20  vRadioButton Checked, CapsLock : Use CapsLock Chang Language
		Gui, Add, Radio, x20  y110 w110 h20  vRadioButton, Alt + Shift	
		Gui, Add, Radio, x130 y110 w110 h20  vRadioButton, Win + Space	
	}
	if (iOpt = 2){
		Gui, Add, Radio, Group x20 y60 w245 h20  vRadioButton, CapsLock : Use CapsLock Chang Language
	...
	if (iOpt = 3){
		Gui, Add, Radio, Group x20 y60 w245 h20  vRadioButton, CapsLock : Use CapsLock Chang Language
		Gui, Add, Radio, x20  y110 w110 h20  vRadioButton, Alt + Shift	
		Gui, Add, Radio, x130 y110 w110 h20  vRadioButton Checked, Win + Space
	}
	;else {
...
Ok:
Gui, Submit
IniWrite, % RadioButton, %A_ScriptDir%\settings.ini, Keys, Key
Return
