...
ShowConfigs(){
	...
	;Gui, Add, Radio, x20  y110 w110 h20 gChangLang vGraveAccent, Alt + Shift
	;Gui, Add, Radio, x130 y110 w110 h20 gChangLang vGraveAccent, Win + Space
...
IfNotExist, LJLANG.ini
	;IniRead, iOpt, %A_ScriptDir%\settings.ini, Options, Option, 1
{
