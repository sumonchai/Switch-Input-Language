...
ShowConfigs(){
	...
	Gui, Add, Radio, x20 y60 w245 h20 vRadioButton Checked, CapsLock : Use CapsLock Chang Language
	
	else Gui, Add, Radio,vRadioButton, x20  y110 w110 h20, Alt + Shift	
		
	if (iOpt = 2)	
		Gui, Add, Radio, x20  y110 w110 h20 Checked,
	
	else Gui, Add, Radio,
		
	if (iOpt = 3)
		
	Gui, Add, Radio, x130 y110 w110 h20 ,Checked,
	...
	;Gui, Add, Radio, x20 y60 w245 h20,  vRadioButton, CapsLock : Use CapsLock Chang Language		
	;Gui, Add, Radio, x20  y110 w110 h20, Alt + Shift	
	;Gui, Add, Radio, x130 y110 w110 h20, Win + Space
	
	;GuiControl,, Option %iOpt%, % (iOpt <> 0)
