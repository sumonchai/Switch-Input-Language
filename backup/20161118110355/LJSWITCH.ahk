...
ShowConfigs(){
	...
	Gui, Font
	Gui, Add, Radio, Group x20 y60 w245 h20 gChangLang vCapsLock, CapsLock : Use CapsLock Chang Language	
	Gui, Add, Radio, x20  y110 w110 h20 gChangLang vHosting, Alt + Shift
...
IniRead:
	...
	Else
	{
		;IniRead, vCapsLock, LJLANG.ini, Key Set, Halo Execution
...
vFullScreen = 0
vWindow = 1
IniWrite, %vCapsLock%, LJLANG.ini, Set Key, Halo Execution
IniWrite, %vFullScreen%, LJLANG.ini, Set Key, Full Screen
IniWrite, %vWindow%, LJLANG.ini, Set Key, Window
Return
