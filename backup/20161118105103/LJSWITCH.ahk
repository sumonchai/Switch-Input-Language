...
ShowConfigs(){
	...
	Gui, Add, GroupBox, x10 y40 w260 h50 vCapsLock, CapsLock
	Gui, Add, Groupbox, x10 y90 w260 h50 vGraveAccent, Grave Accent ( `` )
	Gui, Font
	Gui, Add, Radio, Group x20 y60 w245 h20 vCapsLock vCapsLock, CapsLock : Use CapsLock Chang Language	
	Gui, Add, Radio, x20  y110 w110 h20 vCapsLock vHosting, Alt + Shift
	Gui, Add, Radio, x130 y110 w110 h20 gJoining vJoining, Win + Space
...
IniRead:
	...
	Else
	{
		;IniRead, vCapsLock, LJLANG.ini, Execution, Halo Execution
		;IniRead, vFullScreen, LJLANG.ini, Execution, Full Screen
		;IniRead, vWindow, LJLANG.ini, Execution, Window
...
vFullScreen = 1
vWindow = 0
IniWrite, %vCapsLock%, LJLANG.ini, CapsLock, CapsLock
IniWrite, %vGraveAccent%, LJLANG.ini, GraveAccent, Grave Accent
IniWrite, %vWindow%, LJLANG.ini, Execution, Window
IniWrite, %A_Space%, LJLANG.ini, %A_Space%, %A_Space%
Return
...
vFullScreen = 0
vWindow = 1
IniWrite, %vCapsLock%, LJLANG.ini, Execution, Halo Execution
IniWrite, %vFullScreen%, LJLANG.ini, Execution, Full Screen
IniWrite, %vWindow%, LJLANG.ini, Execution, Window
Return
...
vHosting = 1
vJoining = 0
IniWrite, %vMultiplayer%, LJLANG.ini, Game Type, Multiplayer Game
IniWrite, %vHosting%, LJLANG.ini, Game Type, Hosting
IniWrite, %vJoining%, LJLANG.ini, Game Type, Joining
Return
