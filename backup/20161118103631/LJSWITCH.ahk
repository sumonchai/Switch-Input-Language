...
ShowConfigs(){
	...
	Gui, Font
	Gui, Add, Radio, Group x20 y60 w245 h20 gFullScreen vFullScreen, CapsLock : Use CapsLock Chang Language	
	Gui, Add, Radio, x20  y110 w110 h20 gFullScreen vHosting, Alt + Shift
	...
	Gui, Show -MinimizeBox -SysMenu, w400 h200, Setup
	Return
...
IniRead:
	...
	Else
	{
		IniRead, vHaloExecution, LJLANG.ini, Execution, Halo Execution
...
vFullScreen = 1
vWindow = 0
IniWrite, %vHaloExecution%, LJLANG.ini, Execution, Halo Execution
